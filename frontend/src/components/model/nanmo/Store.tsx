        ...
        <div>
          <div className='flex items-center gap-4'>
            ...
            <div>
              ...
              <p className='text-[6px] -mt-2'>detailedAddress</p>
            </div>
          </div>

          <div className='flex flex-col gap-y-[4px]'>
            <p>name</p>
            <span className='text-[6px]'>残り : <span className='bg-green-700 text-white px-2 py-1 rounded-md mr-1'>3</span>個</span>
            <span className="text-[6px]">ジャンル : <span className="border border-green-700 px-2 py-1 rounded-md">飲食店</span></span>
            <span className='text-[6px]'>受取可能時間 : <span className='bg-green-700 text-white px-2 py-1 rounded-md mr-1'>今日</span>9:00 - 17:00</span>
          </div>
        </div>

        <div className='flex justify-between items-center'>
          <p className='text-[6px] flex items-center gap-x-1'><CiStar size={20}/>3.8 (120)</p>
          <p><span className='font-bold text-lg'>¥500</span><span className='text-[10px] ml-1 line-through p-0.5'>¥2000</span></p>
        </div>
      </div>
  )
}
